          ...
          <div className="card">
            ...
            <div className="footer-card">
              <div className="footer-1">
                ...
                <a
                  href="https://github.com/G-Loganathan/Portfolio"
                  target="blank"
                >
          ...
          <div className="card">
            ...
            <div className="footer-card">
              <div className="footer-1">
                ...
                <a
                  href="https://github.com/G-Loganathan/Form-Validation"
                  target="blank"
                >
                  <i className="icon fa-brands fa-github"></i>
                </a>
              ...
              <div className="footer-2">
                ...
                <a
                  href="https://g-loganathan.github.io/Form-Validation/"
                  target="blank"
                >
                  {" "}
                  <i className="icon fa-solid fa-arrow-up-right-from-square"></i>
          ...
          <div className="card">
            ...
            <div className="footer-card">
              <div className="footer-1">
                ...
                <a
                  href="https://github.com/G-Loganathan/Testimonal-grid-section"
                  target="blank"
                >
                  <i className="icon fa-brands fa-github"></i>
                </a>
              ...
              <div className="footer-2">
                ...
                <a
                  href="https://g-loganathan.github.io/Testimonal-grid-section/"
                  target="blank"
                >
                  <i className="icon fa-solid fa-arrow-up-right-from-square"></i>
                </a>
          ...
          <div className="card">
            ...
            <div className="footer-card">
              <div className="footer-1">
                <p className="stack">HTML | CSS</p>
                <a
                  href="https://github.com/G-Loganathan/Social-proof-section"
                  target="blank"
                >
                  <i className="icon fa-brands fa-github"></i>
                </a>
              ...
              <div className="footer-2">
                ...
                <a
                  href="https://g-loganathan.github.io/Social-proof-section/"
                  target="blank"
                >
                  <i className="icon fa-solid fa-arrow-up-right-from-square"></i>
                </a>
          ...
          <div className="card">
            ...
            <div className="footer-card">
              <div className="footer-1">
                <p className="stack">HTML | CSS</p>
                <a
                  href="https://github.com/G-Loganathan/Product-preview-card-component"
                  target="blank"
                >
                  <i className="icon fa-brands fa-github"></i>
                </a>
              ...
              <div className="footer-2">
                ...
                <a
                  href="https://g-loganathan.github.io/Product-preview-card-component/"
                  target="blank"
                >
                  <i className="icon fa-solid fa-arrow-up-right-from-square"></i>
                </a>
